BootMii Configuration Editor v2.4
...
to change the settings, without having to bring the SD card over to the PC and edit it.


Once launched from the homebrew channel/bannerbomb/etc you can use it to change the 
