...
void parseLanguageFile(char* selLangCode)
{
	...
	//swap
	langsdata = mxmlFindElement(langstree, langstree, "entry", "code", "switch_disabled", MXML_DESCEND);
	swapOptionsDesc[0] = strdup(mxmlElementGetAttr(langsdata,selLangCode));
	langsdata = mxmlFindElement(langstree, langstree, "entry", "code", "switch_enabled", MXML_DESCEND);
	swapOptionsDesc[1] = strdup(mxmlElementGetAttr(langsdata,selLangCode));
	langsdata = mxmlFindElement(langstree, langstree, "entry", "code", "switch_noswap", MXML_DESCEND);
	swapOptionsDesc[2] = strdup(mxmlElementGetAttr(langsdata,selLangCode));
	langsdata = mxmlFindElement(langstree, langstree, "entry", "code", "switch_swap", MXML_DESCEND);
	swapOptionsDesc[3] = strdup(mxmlElementGetAttr(langsdata,selLangCode));	
